...
>
> **当前进度**：Phase 0 仿真框架 9/9 ✅ · Phase 1 基础设施 6/6 ✅ · **Phase 1.5 实机接入进行中** · 固件 Host 135/135（麦轮 64 + 差速 71）· 服务器常驻/恢复已验证 · Pi 5 / Debian 13 / 8 GB / 64 GB 基线已确认 · BOM/五模块边界已冻结（ADR-0018）· HC-SR04 MCU 时序和 Pi 底盘桥已实现（ADR-0013）· 真实 pinmux/机械参数/飞行验收待良乡上机
...
| H2 差速模块 | MSPM0/DRV8871/HC-SR04 协议和 Pi 桥 | SysConfig pinmux、PPR/减速比、IA6B、离地/负载测试 | 🟡 |
| H3 麦轮模块 | STM32/DRV8871/HC-SR04 协议和 Pi 桥 | pinmux、几何、编码器、横移/负载测试 | 🟡 |
| H4 共享车载载荷 | A2M12 256000、ICM42688/OpenMV 实机入口 | I²C 地址、USB 身份、云台标定、两底盘换装复测 | 🟡 |
...
*版本: v6.7 · 日期: 2026-08-02 · v6.7：确认 BOM、五模块边界与 Phase 1.5 工作包*
