...
>
> **2026-08-03 参数/接口覆盖**：按 ADR-0019 同步 1560 counts/rev、真实底盘几何、
> `PD8..11` Trigger 与 `PC6..9/TIM8` Echo；顺序捕获、iBUS、RC 安全状态机和
> GPIO 正交解码共新增 16 个 Host 用例，当前为 80/80。第二 UART 接入与所有接线
> 仍须上板验收。
