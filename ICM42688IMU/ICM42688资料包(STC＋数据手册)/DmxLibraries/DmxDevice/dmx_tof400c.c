...
* @brief    TOF400C模块初始化
* @param    void
* @return   unsigned char			初始化成功返回1
* @notes		
* Example:  Init_TOF400C();
*
**/
unsigned char Init_TOF400C(void)
{
		unsigned char tmp = 0,i=0;
		i = TOF400C_TIMEOUT_COUNT;
		while(tmp == 0)
		{
...
* @param    void
* @return   unsigned int			测量出的距离,单位(cm)
* @notes		
...
* @return   void
* @notes    内部调用
* Example:  TOF400C_Write_Data(0x0000,dat);
*
**/
static void TOF400C_Write_Data(unsigned int reg, unsigned char dat)
{
...
* @return   void
* @notes    内部调用
* Example:  TOF400C_Read_Data(0x0000,dat);
*
**/
static void TOF400C_Read_Data(unsigned int  reg, unsigned char *dat)
{
