...
### 1. 实验前提
本教程使用的是MSPMG3507开发板，对应例程路径为【14.export\MSPM0-K230\03_k230_qrcode】。

k230要运行【14.export\CanmvIDE-K230\03.find_qrcodes.py】程序才能开始实验，建议下载为离线运行程序。
...
4. 当K230摄像头画面识别到二维码时，串口助手就会打印出k230传输给MSPM0的信息。
