...
### 1. 实验前提
本教程使用的是MSPMG3507开发板，对应例程路径为【14.export\MSPM0-K230\14_k230_object_detect】。

k230要运行【14.export\CanmvIDE-K230\14.object_detect_yolov8n.py】程序才能开始实验，建议下载为离线运行程序。
