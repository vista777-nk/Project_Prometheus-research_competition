...
> ⚠️ **已于 2026-08-03 归档，只保留历史证据。** 当前 Raspberry Pi 实机交接见
> [`../docs/experiments/AI_HANDOFF.md`](../docs/experiments/AI_HANDOFF.md)，不得按本文的
> 旧分支、旧日期或旧待办继续执行。
...
> 继续按本文顺序推进。
> 上一份同类文档是 [phase1-pre-departure-brief.md](./phase1-pre-departure-brief.md)（Phase 0→1 交接，已归档）。
>
> **2026-08-03 当前覆盖**：完整 BOM、五个物理模块和最新验收缺口见
> [phase-1.5-hardware-baseline.md](../docs/experiments/phase-1.5-hardware-baseline.md)；ADR-0018
