...
### 1. 实验前提
本教程使用的是MSPMG3507开发板，对应例程路径为【14.export\MSPM0-K230\16_k230_self_learning】。

k230要运行【14.export\CanmvIDE-K230\16.self_learning.py】程序才能开始实验，建议下载为离线运行程序。
...
K230在开机时，画面中会出现一个紫色方框，请将紫框对准要学习的物体，总共有两个物体，根据屏幕提示操作学习两个物体。

两个物体都学习完毕后，紫框中如果出现对应的物体，则会显示物体名称和分数。
...
4. 当K230摄像头画面识别到物体时，串口助手就会打印出k230传输给MSPM0的信息。
