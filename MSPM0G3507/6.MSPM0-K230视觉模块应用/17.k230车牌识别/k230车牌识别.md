...
### 1. 实验前提
本教程使用的是MSPMG3507开发板，对应例程路径为【14.export\MSPM0-K230\17_k230_licence_det_rec】。

k230要运行【14.export\CanmvIDE-K230\17.licence_rec.py】程序才能开始实验，建议下载为离线运行程序。
...
注意：如果发现中文显示乱码，需要将串口助手的字符集编码改成‘UTF-8’编码。
