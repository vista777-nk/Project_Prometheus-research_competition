...
### 1. 实验前提
本教程使用的是MSPMG3507开发板，对应例程路径为【14.export\MSPM0-K230\12_k230_gesture】。

k230要运行【14.export\CanmvIDE-K230\12.gesture.py】程序才能开始实验，建议下载为离线运行程序。
...
其中
- gesture：msg是手势信息，向上‘UP’,向下‘DOWN’，向左‘LEFT’，向右‘RIGHT’，中间‘MIDDLE’
...
4. 当K230摄像头画面识别到手掌，并且手掌做出对应手势时，串口助手就会打印出k230传输给MSPM0的信息。

  - 其中
    - gesture：是手势信息，向上‘UP’,向下‘DOWN’，向左‘LEFT’，向右‘RIGHT’，中间‘MIDDLE’
