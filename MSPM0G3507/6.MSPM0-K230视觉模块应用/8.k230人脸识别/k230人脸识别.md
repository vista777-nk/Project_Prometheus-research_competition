...
### 1. 实验前提
本教程使用的是MSPMG3507开发板，对应例程路径为【14.export\MSPM0-K230\08_k230_face_recognition】。

k230要运行【14.export\CanmvIDE-K230\08.face_recognition.py】程序才能开始实验，建议下载为离线运行程序。由于人脸识别功能需要提前注册人脸信息，所以请先参考【7.人脸识别\7. 注册人脸识别】课程，注册完人脸再进行此实验。
...
4. 当K230摄像头画面识别到人脸时，串口助手就会打印出k230传输给MSPM0的信息。
